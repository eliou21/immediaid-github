...
export default function AddAdminScreen({ navigation }) {
  ...
  const addAdmin = async () => {
    ...
    const newAdmin = {
      name,
      email,
      password, // Consider hashing before storage in a real app
      profilePicture,
    };
            ...
            <View style={styles.container}>
              <View style={styles.profileSection}>
                ...
                <TouchableOpacity onPress={pickImage} style={styles.profileContainer}>
                  <Image
                    source={profilePicture ? { uri: profilePicture } : require("../assets/default.png")}
                ...
                {/* Save Button */}
                <TouchableOpacity style={styles.saveButton} onPress={addAdmin}>
                  <Text style={styles.saveText}>Add Admin</Text>
                </TouchableOpacity>
